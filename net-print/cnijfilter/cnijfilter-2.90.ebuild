...
#
# initial version
# updated to use cnijfilter-common-2.90 2009-11-15
#

inherit eutils rpm flag-o-matic multilib

DESCRIPTION="Canon InkJet Printer Driver for Linux (Pixus/Pixma-Series)."
HOMEPAGE="http://support-asia.canon-asia.com/contents/ASIA/EN/0100119202.html"
RESTRICT="nomirror confcache"

SRC_URI="http://gdlp01.c-wss.com/gds/2/0100001192/01/cnijfilter-common-2.90-1.tar.gz"
...
_prname=(${_pruse[@]})
_prid=("303" "331")
_prcomp=("ip100series" "ip2600series")
...
pkg_setup() {
	...
	if (${_autochoose}); then
		...
		einfo ""
		einfo "As example:\tbasic iP100 support without maintenance tools"
		einfo "\t\t -> USE=\"ip100\""
		einfo ""
